...
class complor_network(nn.Module):
    def __init__(self, num_classes, d_model, d_out, max_m, rank):
        ...
        self.cnn1 = nn.Sequential( nn.Conv1d(self.d_model,32,2, stride=1), 
                                   ...
                                   nn.ReLU(),
                                   nn.Conv1d(64,int(self.d_out),2, stride=1)
                                   ) ##8 size motifs
        self.ln1 = nn.LayerNorm(self.d_out)
               
        self.cnn2 = nn.Sequential( nn.Conv1d(self.d_model,32,3, stride=1), 
                                   nn.ReLU(),
                                   nn.Conv1d(32,64,2, stride=1),
                                   nn.ReLU(),
        ...
        self.cnn3 = nn.Sequential( nn.Conv1d(self.d_model,32,2, stride=1), 
                                   nn.ReLU(),
                                   nn.Conv1d(32,64,2, stride=1),
                                   nn.ReLU(),
        ...
        self.cnn4 = nn.Sequential( nn.Conv1d(self.d_model,32,4, stride=1), 
                                   nn.ReLU(),
        ...
        self.gln = nn.LayerNorm(self.d_model)
        ...
        self.maxpool3 = nn.Sequential( nn.AvgPool1d(2, stride=1),
                                       nn.AvgPool1d(2, stride=1),
                                       nn.AvgPool1d(2, stride=1),
                                       nn.AvgPool1d(2, stride=1),
                                   )
        self.motif_size_3 = 16
        
        self.maxpool4 = nn.Sequential( nn.AvgPool1d(4, stride=1),
                                       nn.AvgPool1d(3, stride=1),
                                       nn.AvgPool1d(2, stride=1),
                                   )
        self.motif_size_4 = 24
    ...
    def forward_motif_importance(self, x,  classes, seq_len):
        ...
        self.pool_1 = self.normalize_comp(self.pool_1, seq_len)
