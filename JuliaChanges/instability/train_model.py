...
global q
q = len(amino_acids)
print("Amino acids considered:", amino_acids)
...
def make_dataset_with_masking(mask_percentage=10):        
...
def train(num_epochs, init_lr, max_m):
    ...
    for epoch in range(num_epochs):
        avg_loss = 0
        train_loader, valid_loader, valid_size  = make_dataset_with_masking(mask_percentage=10)
